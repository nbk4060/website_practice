            ...
            <div className='relative'>
                ...
                <div className='mx-auto container '>
                      ...
                      <div className="w-px h-full bg-white relative"></div>
                        <p className='font-font_family font-medium italic text-2xl leading-[24px] text-[#9CA3AF] mt-10 pl-24'>LearnForce</p>
                      
                        <p className='font-font_family font-bold not-italic text-[40px] text-white leading-[44px] mt-10 pl-24'>End-to-end engineering of Europe’s biggest learning platform</p>
                        ...
                        <button className='font-sans font-medium not-italic text-xl leading-5 text-white mt-28 mx-auto container flex justify-center'>VIEW ALL WORK</button>
                ...
                <div className='mx-auto mt-7 border-y border-gray-900 z-50'>
                <div className='w-full h-full inset-0 bg-[url("/background_line_image.png")] bg-no-repeat bg-cover'>
                    <div className='mx-auto container flex flex-col justify-center font-font_family font-bold not-italic text-white text-7xl leading-[97.2px] pt-32'>
                        Top 0.1% of Talent.White Glove, Start to Finish.Results, No Matter What.</div>
                    <div className='mx-auto container flex flex-row justify-center gap-8 mt-96 pb-24 pl-20 mx-48'>
                      <Four_div_text  
                      title={"1. Design"} 
               ...
               <div className='border-y border-gray-900 relative'>
               ...
               <div className='mx-auto container relative'>
                ...
                <div className="flex gap-40 mt-16">
                    <div>
                        ...
                        <div><button className="text-white font-font_family font-normal not-italic text-2xl leading-6 underline">Get in touch </button></div>
                    ...
                    <div>
                        ...
                        <div className='font-sans font-medium not-italic text-lg text-gray-400 mt-5'>4275 Executive Square, Suite 200
                         LA Jolla, CA 92037</div>
                    </div>

                     <div>
                        <h1 className="font-font_family font-medium not-italic text-xl text-white leading-5">Islamabad</h1>
                        <div className='font-sans font-medium not-italic text-lg text-gray-400 mt-5'>Suite 301-305, Ground Floor, NSTP, NUST H-12, Islamabad</div>
                        <div className='font-sans font-medium not-italic text-lg text-gray-400 mt-10'>Suite 301-305, Ground Floor, NSTP, NUST H-12, Islamabad</div>
                    </div>
                    </div>    
                ...
                <div className='border-y border-gray-900 mt-16 pb-10 relative'>
                <div className='mx-auto container'>
                    ...
                    <div className='flex gap-72'>
                        ...
                        <div className='mt-11 flex gap-10 font-sans font-medium not-italic text-lg leading-3 text-gray-400'>
